...
export interface ApiBilderarchivBilderarchiv
  extends Struct.CollectionTypeSchema {
  collectionName: 'bilderarchivs';
  info: {
    displayName: 'Bilderarchiv';
    pluralName: 'bilderarchivs';
    singularName: 'bilderarchiv';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Jahr: Schema.Attribute.Integer;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::bilderarchiv.bilderarchiv'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Veranstaltung: Schema.Attribute.String;
  };
}
...
export interface ApiJugendtheaterstueckJugendtheaterstueck
  extends Struct.CollectionTypeSchema {
  collectionName: 'jugendtheaterstuecke';
  info: {
    description: '';
    displayName: 'Jugendtheaterst\u00FCck';
    pluralName: 'jugendtheaterstuecke';
    singularName: 'jugendtheaterstueck';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::jugendtheaterstueck.jugendtheaterstueck'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiKulturboteKulturbote extends Struct.CollectionTypeSchema {
  ...
  info: {
    displayName: 'Kulturbote';
    pluralName: 'kulturbotes';
    singularName: 'kulturbote';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    KulturbotePDF: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::kulturbote.kulturbote'
    > &
      Schema.Attribute.Private;
...
export interface ApiLinksLinks extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::links.links'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiMitgliedsantragMitgliedsantrag
  extends Struct.SingleTypeSchema {
  collectionName: 'mitgliedsantrags';
  info: {
    displayName: 'Mitgliedsantrag';
    pluralName: 'mitgliedsantrags';
    singularName: 'mitgliedsantrag';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::mitgliedsantrag.mitgliedsantrag'
    > &
      Schema.Attribute.Private;
    Mitgliedsantrag: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiSatzungSatzung extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Satzung: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiTheaterstueckTheaterstueck
  ...
  info: {
    description: '';
    displayName: 'Theaterst\u00FCck';
    pluralName: 'theaterstuecke';
    singularName: 'theaterstueck';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::theaterstueck.theaterstueck'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    Titel: Schema.Attribute.String;
    Titelbild: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiUnsereGeschichteUnsereGeschichte
  extends Struct.SingleTypeSchema {
  collectionName: 'unsere_geschichtes';
  info: {
    displayName: 'Unsere Geschichte';
    pluralName: 'unsere-geschichtes';
    singularName: 'unsere-geschichte';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Geschichte: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::unsere-geschichte.unsere-geschichte'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiVorstandschaftVorstandschaft
  extends Struct.CollectionTypeSchema {
  collectionName: 'vorstandschafts';
  info: {
    displayName: 'Vorstandschaft';
    pluralName: 'vorstandschafts';
    singularName: 'vorstandschaft';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vorstandschaft.vorstandschaft'
    > &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
...
export interface ApiVorstandschaftsfotoVorstandschaftsfoto
  extends Struct.SingleTypeSchema {
  collectionName: 'vorstandschaftsfotos';
  info: {
    displayName: 'Vorstandschaftsfoto';
    pluralName: 'vorstandschaftsfotos';
    singularName: 'vorstandschaftsfoto';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::vorstandschaftsfoto.vorstandschaftsfoto'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Vorstandschaftsfoto: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::bilderarchiv.bilderarchiv': ApiBilderarchivBilderarchiv;
